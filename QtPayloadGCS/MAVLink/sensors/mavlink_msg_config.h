...
typedef struct __mavlink_config_t {
 ...
 uint8_t pyranometerComPortNum; /*<  The serial port number for the Pyranometer.*/
...
#define MAVLINK_MSG_ID_CONFIG_LEN 8
#define MAVLINK_MSG_ID_CONFIG_MIN_LEN 8
#define MAVLINK_MSG_ID_150_LEN 8
#define MAVLINK_MSG_ID_150_MIN_LEN 8

#define MAVLINK_MSG_ID_CONFIG_CRC 53
#define MAVLINK_MSG_ID_150_CRC 53
...
#define MAVLINK_MESSAGE_INFO_CONFIG { \
    ...
    {  { "windSensorStatus", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_config_t, windSensorStatus) }, \
         ...
         { "pyranometerComPortNum", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_config_t, pyranometerComPortNum) }, \
         { "oplsStatus", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_config_t, oplsStatus) }, \
         { "oplsComPortNum", NULL, MAVLINK_TYPE_UINT8_T, 0, 7, offsetof(mavlink_config_t, oplsComPortNum) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CONFIG { \
 ...
 * @param pyranometerComPortNum  The serial port number for the Pyranometer.
...
static inline uint16_t mavlink_msg_config_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t windSensorStatus, uint8_t windSensorType, uint8_t windSensorComPortNum, uint8_t lidarStatus, uint8_t pyranometerStatus, uint8_t pyranometerComPortNum, uint8_t oplsStatus, uint8_t oplsComPortNum)
{
    ...
    _mav_put_uint8_t(buf, 5, pyranometerComPortNum);
    _mav_put_uint8_t(buf, 6, oplsStatus);
    _mav_put_uint8_t(buf, 7, oplsComPortNum);
    ...
    packet.pyranometerComPortNum = pyranometerComPortNum;
...
{
    return mavlink_msg_config_pack(system_id, component_id, msg, config->windSensorStatus, config->windSensorType, config->windSensorComPortNum, config->lidarStatus, config->pyranometerStatus, config->pyranometerComPortNum, config->oplsStatus, config->oplsComPortNum);
}
...
{
    return mavlink_msg_config_pack_chan(system_id, component_id, chan, msg, config->windSensorStatus, config->windSensorType, config->windSensorComPortNum, config->lidarStatus, config->pyranometerStatus, config->pyranometerComPortNum, config->oplsStatus, config->oplsComPortNum);
}
...
static inline void mavlink_msg_config_send(mavlink_channel_t chan, uint8_t windSensorStatus, uint8_t windSensorType, uint8_t windSensorComPortNum, uint8_t lidarStatus, uint8_t pyranometerStatus, uint8_t pyranometerComPortNum, uint8_t oplsStatus, uint8_t oplsComPortNum)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CONFIG_LEN];
    _mav_put_uint8_t(buf, 0, windSensorStatus);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_config_send(chan, config->windSensorStatus, config->windSensorType, config->windSensorComPortNum, config->lidarStatus, config->pyranometerStatus, config->pyranometerComPortNum, config->oplsStatus, config->oplsComPortNum);
#else
 ...
 */
static inline void mavlink_msg_config_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t windSensorStatus, uint8_t windSensorType, uint8_t windSensorComPortNum, uint8_t lidarStatus, uint8_t pyranometerStatus, uint8_t pyranometerComPortNum, uint8_t oplsStatus, uint8_t oplsComPortNum)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field pyranometerComPortNum from config message
 *
 * @return  The serial port number for the Pyranometer.
 */
static inline uint8_t mavlink_msg_config_get_pyranometerComPortNum(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_config_decode(const mavlink_message_t* msg, mavlink_config_t* config)
{
    ...
    config->pyranometerComPortNum = mavlink_msg_config_get_pyranometerComPortNum(msg);
